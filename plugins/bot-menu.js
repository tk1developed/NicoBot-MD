...
await conn.reply(m.chat, menu, a, { contextInfo: { externalAdReply: {title: '👋 ¡Hola!', sourceUrl: yt, thumbnail: await (await fetch(pp)).buffer() }}})
