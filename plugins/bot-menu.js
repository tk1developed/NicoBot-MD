...
await conn.reply(m.chat, menu, fkontak, { contextInfo: { externalAdReply: {title: 'ꪶໍٜ߭۫ި᮫ׅ࣪۬߭ׄ𖾏🍨𝚮͜ᴏ፝ʟ⃨ᴀ⃨⃕🍫 ' + user, body: wm, sourceUrl: md, thumbnail: await (await fetch(pp)).buffer() }}})
