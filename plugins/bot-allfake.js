...
let pp = 'https://telegra.ph/file/1861aab98389b13db8588.jpg'
...
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: `${wm}\n${saludo}`, orderTitle: 'Bang', thumbnail: pp, sellerJid: '0@s.whatsapp.net'}}}
