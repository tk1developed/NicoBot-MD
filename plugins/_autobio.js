...
let grupos = [channel, gp1, gp2, gp3]
let gata = [imagen1, imagen4, imagen6]
...
await delay(3 * 3000)
let res = await conn.groupAcceptInvite(code) 
conn.reply(m.chat, `😻 *SE HA UNIDO GATABOT AL GRUPO!!!*`, m).then(async() => { //Si el Owner se une al Grupo no habrá temporizador
