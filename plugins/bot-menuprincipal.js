...
┃֪࣪  ╰─ׅ─ׅ┈ ─๋︩︪─🍂🍁🍂─ׅ─ׅ┈ ─๋︩︪─╯
╔╼𝅄━ִⷡ━ִⷪ𝅄ͭ━ִ━ִ𝆺𝅥🔥   ۫ 𝆺𝅥⋆ ִ ۫ 𝆺𝅥 ִ🔥 ۫ ⊹━ͥ━ִꙵ𝅄━ᷫ━ִⷪ𝅄╾࣪╗
┃֪࣪֝፝֟͜🔥͡⁄⌱🄲ʀᴇᴀᴅᴏʀ: %author
┃֪࣪֝፝֟͜🔥͡⁄⌱🅲︎ʟɪᴇɴᴛᴇ: %name
┃֪࣪֝፝֟͜🔥͡⁄⌱🆁︎ᴜɴᴛɪᴍᴇ: %muptime
┃֪࣪֝፝֟͜🔥͡⁄⌱🅄sᴜᴀʀɪᴏs: %totalreg
┃֪࣪֝፝֟͜🔥͡⁄⌱🆅︎ᴇʀᴄɪᴏɴ: 1.0.7
╚╼𝅄━ִ━ִ𝅄━ִ━ִ𝆺𝅥 𝆭🔥 ۫ 𝆺𝅥⋆ ִ ۫ 𝆺𝅥 ִ🔥 ۫ ⊹━ִ━ִ𝅄━━ִ?

.    ╭─ׅ─ׅ┈ ─๋︩︪─🍂🍁🍂─ׅ─ׅ┈ ─๋︩︪─╮
╭╼☁️⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪ 🄸🄽🄵🄾×🅄🅂🄴🅁໑⃪࣭۪ٜ݊݊݊݊𑁍ꥈ࣪⬪☁️
┃֪࣪  ╰─ׅ─ׅ┈ ─๋︩︪─🍂🍁🍂─ׅ─ׅ┈ ─๋︩︪─╯
╔╼𝅄━ִⷡ━ִⷪ𝅄ͭ━ִ━ִ𝆺𝅥🔥   ۫ 𝆺𝅥⋆ ִ ۫ 𝆺𝅥 ִ🔥 ۫ ⊹━ͥ━ִꙵ𝅄━ᷫ━ִⷪ𝅄╾࣪╗
┃֪࣪֝፝֟͜🔥͡⁄⌱🆃︎ᴀɢ: %taguser
┃֪࣪֝፝֟͜🔥͡⁄⌱🄴xᴘ: %totalexp
┃֪࣪֝፝֟͜🔥͡⁄⌱🅲︎ᴏɪɴs: %limit
┃֪࣪֝፝֟͜🔥͡⁄⌱🄽ɪᴠᴇʟ: %level
╚╼𝅄━ִ━ִ𝅄━ִ━ִ𝆺𝅥 𝆭🔥 ۫ 𝆺𝅥⋆ ִ ۫ 𝆺𝅥 ִ🔥 ۫ ⊹━ִ━ִ𝅄━━ִ?
%readmore
.    ╭─ׅ─ׅ┈ ─๋︩︪─🍂🍁🍂─ׅ─ׅ┈ ─๋︩︪─╮
...
┃֪࣪֝፝֟͜🔥͡⁄⌱#contactos
┃֪࣪֝፝֟͜🔥͡⁄⌱#blocklist
╚╼𝅄━ִ━ִ𝅄━ִ𝆺𝅥 𝆭🔥 ۫ 𝆺𝅥⋆ ִ ۫ 𝆺𝅥 ִ🔥 ۫ ⊹━ִ𝅄━━ִ?

         *乂 ⺀ ʟɪꜱᴛᴀ - ᴄᴏᴍᴀɴᴅᴏꜱ ⺀ 乂*
`.trimStart(),
  header: '.    ╭─ׅ─ׅ┈ ─๋︩︪─🍂🍁🍂─ׅ─ׅ┈ ─๋︩︪─╮\n╭╼☁️⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪ %category ໑⃪࣭۪ٜ݊݊݊݊𑁍ꥈ࣪⬪☁️\n┃֪࣪  ╰─ׅ─ׅ┈ ─๋︩︪─🍂🍁🍂─ׅ─ׅ┈ ─๋︩︪─╯\n╔╼𝅄━ִⷪ𝅄ͭ━ִ𝆺𝅥🔥   ۫ 𝆺𝅥⋆ ִ ۫ 𝆺𝅥 ִ🔥 ۫ ⊹━ִꙵ𝅄━ִⷪ𝅄╾࣪╗',
  body: '┃֪࣪֝፝֟͜🔥͡⁄⌱ *%cmd*\n',
  footer: '╚╼𝅄━ִ𝅄━ִ𝆺𝅥 𝆭🔥 ۫ 𝆺𝅥⋆ ִ ۫ 𝆺𝅥 ִ🔥 ۫ ⊹━ִ𝅄━ִ?\n',
  after: 'Bʏ: おDɪᴇɢᴏ Oғᴄ',
}
