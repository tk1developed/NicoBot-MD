...
let biografia = await conn.fetchStatus('573107133321' +'@s.whatsapp.net').catch(_ => 'Sin Biografía')
let biografiaBot = await conn.fetchStatus('573107133321' +'@s.whatsapp.net').catch(_ => 'Sin Biografía')
