...
[`${conn.user.jid.split('@')[0]}`, `𝗘𝘀 𝗨𝗻𝗮 𝗕𝗼𝘁 🍃`, `${await conn.getName(conn.user.jid)}`, `📵 No Hacer Spam`, 'yotsuba399@gmail.com', `🇨🇴 Colombia`, `https://github.com/Diego-YL-177/YoshikoBot-MD`, biobot]
], m)
