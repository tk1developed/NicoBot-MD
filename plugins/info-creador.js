...
[`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `✨️ Esta Cuenta Es Un Bot`, `📵 No Hacer Spam`, 'theyotsubanakano@gmail.com', `🇨🇴 Colombia`, `https://github.com/Diego-YL-177/Yotsuba-Nakano-MD`, biobot]
], m)
