...
if (!_registro[0]) return conn.reply(m.chat, `*FALTA SU NOMBRE, PARÁMETROS DEL REGISTRO:*\n\`\`\`${usedPrefix + command} nombre edad\`\`\``, fkontak, m)
...
if (!_registro[1]) return conn.reply(m.chat, `*FALTA SU EDAD, PARÁMETROS DEL REGISTRO:*\n\`\`\`${usedPrefix + command} nombre edad\`\`\``, fkontak, m)
if (_registro[1] > 90) return conn.reply(m.chat, `*⚠️CARAJO, ESTAS MUY VIEJO👴👵, USE OTRA EDAD POR FAVOR⚠️*\n\n*PARÁMETROS DEL REGISTRO:*\n\`\`\`${usedPrefix + command} nombre edad\`\`\``, fkontak, m)
if (_registro[1] < 10) return conn.reply(m.chat, `*⚠️CARAJO, ESTAS MUY NIÑO👶, USE OTRA EDAD POR FAVOR⚠️*\n\n*PARÁMETROS DEL REGISTRO:*\n\`\`\`${usedPrefix + command} nombre edad\`\`\``, fkontak, m)
...
if (text.length <= 2) return conn.sendMessage(m.chat, {text: `*NOMBRE FALTANTE O MUY CORTO, EJEMPLO:*\n${usedPrefix}nombre ${gt}\n\n🌟 *SI QUIERE USAR SU NOMBRE QUE TIENE REGISTRADO EN SU WHATSAPP, ESCRIBA:*\n_${usedPrefix}nombre2_`}, {quoted: fkontak})
user.name = text.replace(/\s+/g, '').replace(/[0-9]+/gi, "").trim()
if (user.name) return conn.sendMessage(m.chat, {text: `🌟 *GENIAL!! SE HA COMPLETADO LO SIGUIENTE*\n*- - - - - - - - - - - - - - - - - - - - - - - - - - - -*\n\n*❖ NOMBRE:*\n${user.name === 0 ? sinDefinir : user.name}\n\n🔢 *AHORA PUEDE REGISTRAR SU EDAD, EJEMPLO:*\n\`\`\`${usedPrefix}edad 20\`\`\``}, {quoted: fkontak})
}

if (command == 'nombre2' || command == 'name2') {
if (/^\d+$/.test(text)) return conn.sendMessage(m.chat, {text: `*SU NOMBRE NO DEBE DE TENER SÓLO NÚMEROS, EJEMPLO:*\n${usedPrefix}nombre ${gt}\n\n🌟 *SI QUIERE USAR SU NOMBRE QUE TIENE REGISTRADO EN SU WHATSAPP, ESCRIBA:*\n*${usedPrefix}nombre2*`}, {quoted: fkontak})
if (nombreWA.slice(1).length < 2) return conn.sendMessage(m.chat, {text: `*SU NOMBRE DE WHATSAPP ES MUY CORTO PARA REGISTRAR*\n\n*MODIFIQUE SU HOMBRE DE WHATSAPP E INTENTE NUEVAMENTE O PUEDE PERSONALIZAR SU NOMBRE USANDO EL COMANDO:*\n*${usedPrefix}nombre ${gt}*`}, {quoted: fkontak})
if (nombreWA.slice(1).length > 25) return conn.sendMessage(m.chat, {text: `*SU NOMBRE DE WHATSAPP ES MUY LARGO PARA REGISTRAR*\n\nMODIFIQUE SU HOMBRE DE WHATSAPP E INTENTE NUEVAMENTE O PUEDE PERSONALIZAR SU NOMBRE USANDO EL COMANDO:*\n*${usedPrefix}nombre ${gt}*`}, {quoted: fkontak})
user.name = nombreWA.replace(/\s+/g, '').replace(/[0-9]+/gi, "").slice(1).trim()
if (user.name) return conn.sendMessage(m.chat, {text: `🌟 *GENIAL!! SE HA COMPLETADO LO SIGUIENTE*\n*- - - - - - - - - - - - - - - - - - - - - - - - - - - -*\n\n*◉ NOMBRE:*\n${user.name === 0 ? sinDefinir : user.name}\n\n➢ *AHORA PUEDE REGISTRAR SU EDAD, EJEMPLO:*\n\`\`\`${usedPrefix}edad 20\`\`\``}, {quoted: fkontak})
}

if (command == 'edad' || command == 'age' || command == 'edad2' || command == 'age2') {
if (verificar.test(text.slice(1)) == false && !text) return conn.sendMessage(m.chat, {text: `*👉 AGREGUÉ SU EDAD PARA REGISTRAR, EJEMPLO:*\n${usedPrefix}edad 20`}, {quoted: fkontak})
if (isNaN(text)) return conn.reply(m.chat, `*INGRESE SOLO NÚMEROS*`, fkontak, m)
...
if (text == 0 && text > 3) return conn.reply(m.chat, `*"${text}" NO ES VÁLIDO PARA ELEGIR, RECUERDE USAR EL EMOJI NUMÉRICO, EMOJI DE GÉNERO O TEXTO NUMÉRICO PARA SELECCIONAR SU GÉNERO, EJEMPLO*\n\n✓ \`\`\`${usedPrefix}genero 2️⃣\`\`\`\n✓ \`\`\`${usedPrefix}genero 2\`\`\``, fkontak, m) 
switch (text) {
case "1️⃣":
case "1":
case "🚹":
...
break
default:
return conn.reply(m.chat, `*RECUERDE USAR EL EMOJI NUMÉRICO, EMOJI DE GÉNERO O TEXTO NUMÉRICO PARA SELECCIONAR SU GÉNERO, EJEMPLO*\n\n✓ \`\`\`${usedPrefix}genero 2️⃣\`\`\`\n✓ \`\`\`${usedPrefix}genero 2\`\`\``, fkontak, m)
}}
asignarGenero(text)
user.genero = genero
...
return conn.reply(m.chat, `*RECUERDE USAR EL EMOJI NUMÉRICO, EMOJI DE GÉNERO O TEXTO NUMÉRICO PARA SELECCIONAR SU IDENTIDAD, EJEMPLO*\n\n✓ \`\`\`${usedPrefix}identidad 2️⃣\`\`\`\n✓ \`\`\`${usedPrefix}identidad 2\`\`\``, fkontak, m)
}else{
conn.reply(m.chat, `*ESTÁ ELECCIÓN "${numero}" NO FORMA PARTE DE LA LISTA DE IDENTIDAD, ELEGIR UNO DE LA LISTA POR FAVOR, EJEMPLO:*\n\n✓ \`\`\`${usedPrefix}identidad 2️⃣\`\`\`\n✓ \`\`\`${usedPrefix}identidad 2\`\`\``, fkontak, m)
}}
let yyr = ''
yyr += `*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈•*
...
conn.reply(m.chat, `*EL PASATIEMPO "${!pasatiempoIngresado ? 'CON LETRAS 🔡' : pasatiempoIngresado === undefined ? 'DE ALGUNA POSICIÓN' :  pasatiempoIngresado}" NO FORMA PARTE DE LA LISTA DE PASATIEMPOS*`, fkontak, m)
return
}}        
...
global.db.data.users[m.sender]['registroC'] = true
conn.sendMessage(m.chat, {text: `*GENIAL!! SE HA AGREGADO LOS PASATIEMPOS*\n*- - - - - - - - - - - - - - - - - - - - - - - - - - - -*\n\n*${user.pasatiempo === 0 ? sinDefinir : user.pasatiempo}*\n\n🌟 *PARA GUARDAR SU REGISTRO ESCRIBA:*\n\`\`\`${usedPrefix}finalizar\`\`\``}, {quoted: fkontak})        
//console.log("Pasatiempos por separado:", pas1, pas2, pas3, pas4, pas5)
}else{
conn.reply(m.chat, `*EL PASATIEMPO "${pasatiempoSeleccionado === undefined ? 'DE ALGUNA POSICIÓN' : pasatiempoSeleccionado }" YA HA SIDO SELECCIONADO*`, fkontak, m)
}} else {
