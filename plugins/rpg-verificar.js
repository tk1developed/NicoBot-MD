...
• 5 Monedas 🪙
┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
𝚄𝚂𝚄𝙰𝚁𝙸𝙾𝚂 𝙰𝙲𝚃𝙸𝚅𝙾𝚂 𝙴𝙽 𝙼𝙸 𝙱𝙰𝚂𝙴: ${rtotalreg}`, fkontak, {contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: packname, body: `👋🏻 Hola ` + nombre, previewType: 0, thumbnail: imagen6, sourceUrl: [channel, md, yt, fb].getRandom()}}})
await m.reply(`${sn}`)}
