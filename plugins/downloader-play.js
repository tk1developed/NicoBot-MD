...
let by = 'Ⓨ︎ 𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝑩𝒚: 𝒀𝒐𝒕𝒔𝒖𝒃𝒂 𝑵𝒂𝒌𝒂𝒏𝒐'
await conn.sendMessage(m.chat, { video: { url: mediaa.result }, fileName: `error.mp4`, caption: by, thumbnail: mediaa.thumb, mimetype: 'video/mp4' }, { quoted: m })     
} catch {
