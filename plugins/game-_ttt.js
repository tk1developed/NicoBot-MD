...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} 𝐸𝑥𝑖𝑡𝑜, 𝐺𝑎𝑛𝑎𝑠𝑡𝑒𝑠: +1209 𝚎𝚡𝚙` : isTie ? '𝙴𝙻 𝙹𝚄𝙴𝙶𝙾 𝚃𝙴𝚁𝙼𝙸𝙽𝙾 𝙴𝙽 𝙴𝙼𝙿𝙰𝚃𝙴 😐' : `𝑻𝒖𝒓𝒏𝒐 𝑫𝒆: @${room.game.currentTurn.split('@')[0]}`}
`.trim();
