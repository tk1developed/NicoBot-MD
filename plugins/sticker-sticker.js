...
if (!/webp|image|video/g.test(mime) && !text) return m.reply(`⚠️ *Hey La Conversión A Fallado, Intenta Enviar Un Video O Una Imagen Y Luego Responde Con El Comando !s*`)
