...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  try {
    ...
    try {
      ...
      await conn.sendMessage(m.chat, {video: {url: mediaa.result}, fileName: `error.mp4`, caption: ` ❥ᰰຼ ⃟ᬽ៸𝙈𝙪𝙡𝙩𝙞𝙫𝙚𝙧𝙨𝙚𝘽𝙤𝙩-𝙈𝘿༒★»`, thumbnail: mediaa.thumb, mimetype: 'video/mp4'}, {quoted: m});
      await conn.sendMessage(m.chat, {text: '*🧩 Video Descargado Exitosamente*', edit: key}, {quoted: m});
      enviando = false
    } catch {
      try {
