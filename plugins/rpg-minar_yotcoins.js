const handler = async (m, {conn, isPrems}) => { // lastmiming
  ...
  const pp = 'https://telegra.ph/file/9189e72ffd2c8fbc48cc2.jpg';
  ...
  await conn.sendFile(m.chat, pp, 'yoshiko.jpg', text, m);
  user.lastcoins = new Date * 1;
};
handler.help = ['minar2'];
handler.tags = ['gata'];
handler.command = ['minar2', 'miming2', 'mine2', 'minaryoshi', 'minarcoins', 'minarshin'];
handler.fail = null;
handler.exp = 0;
