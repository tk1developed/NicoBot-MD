...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
        ...
        let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Yejota, tu seras Shinonome - Bot.`;
      ...
      try {
        conn.sendPresenceUpdate('composing', m.chat);
        const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por YeJota, tu seras Shinonome - Bot.`;
