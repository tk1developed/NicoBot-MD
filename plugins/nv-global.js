...
handler.all = async function(m, {conn}) {
  ...
  if (/^hola$/i.test(m.text) && !chat.isBanned) {
    ...
    mconn.conn.sendMessage(m.chat, {audio: {url: vn}, fileName: 'error.mp3', mimetype: 'audio/mpeg', ptt: true}, {quoted: fkontak});
  }
