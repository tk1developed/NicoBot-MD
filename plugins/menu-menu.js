...
await conn.reply(m.chat, '*𝐄𝐧𝐯𝐢𝐚𝐧𝐝𝐨 𝐄𝐥 𝐌𝐞𝐧𝐮 𝐃𝐞 𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭-𝐌𝐃...*', fkontak, { contextInfo:{ forwardingScore: 2022, isForwarded: true, externalAdReply: {title: '👋 Hola Baby!!', body: saludo, sourceUrl: global.ig, thumbnailUrl: ppBot }}})
m.react('📚') 
...
handler.help = ['help']
handler.tags = ['main']
handler.command = ['help', 'menucompleto', 'menu'] 
