...
const handler = async (m, {conn, text, participants, args}) => {
  ...
  try {
    ...
    for (const user of participant.filter((item) => item.attrs.error == 403)) {
      ...
      const captionn = `😊 𝗛𝗲𝘆 𝗔𝗺𝗶𝗴𝗼(𝗮) 𝗦𝗼𝘆 𝗟𝗮 𝗕𝗼𝘁 𝗬𝗼𝘀𝗵𝗶𝗸𝗼𝗕𝗼𝘁-𝗠𝗗 𝗨𝗻 𝗕𝗼𝘁 𝗗𝗶𝘀𝗲𝗻̃𝗮𝗱𝗼 𝗣𝗮𝗿𝗮 𝗔𝘆𝘂𝗱𝗮𝗿𝘁𝗲, 𝗨𝗻 𝗔𝗱𝗺𝗶𝗻𝗶𝘀𝘁𝗿𝗮𝗱𝗼𝗿 𝗛𝗮 𝗨𝘀𝗮𝗱𝗼 𝗘𝗹 𝗖𝗼𝗺𝗮𝗻𝗱𝗼 𝗣𝗮𝗿𝗮 𝗔𝗴𝗿𝗲𝗴𝗮𝗿𝘁𝗲 𝗔 𝗨𝗻 𝗚𝗿𝘂𝗽𝗼 𝗣𝗲𝗿𝗼 𝗡𝗼 𝗣𝘂𝗲𝗱𝗼 𝗔𝗻̃𝗮𝗱𝗶𝗿𝘁𝗲 𝗔𝘀𝗶 𝗤𝘂𝗲 𝗧𝗲 𝗘𝗻𝘃𝗶𝗼 𝗘𝗻 𝗘𝗻𝗹𝗮𝗰𝗲 𝗣𝗮𝗿𝗮 𝗤𝘂𝗲 𝗧𝗲 𝗨𝗻𝗮𝘀, 𝗧𝗲 𝗘𝘀𝗽𝗲𝗿𝗮𝗺𝗼𝘀 💫🌟`;
