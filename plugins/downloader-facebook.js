...
if (!args[0].match(/www.facebook.com|fb.watch|web.facebook.com|business.facebook.com|video.fb.com/g)) return conn.reply(m.chat, '🎌 *No es un enlace válido*')
await conn.reply(m.chat, '⏰ Espere un momento')
m.react(done)
