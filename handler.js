...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '📖'  + saludo + ' ' + taguser, body: '𝐁𝐲: Dɪᴇɢᴏ.Oғᴄ', thumbnail: ImgAll.getRandom(), sourceUrl: 'https://whatsapp.com/channel/0029VaQD7LAJP216tu9liI2A'}}}}, aa);
