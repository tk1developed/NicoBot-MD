...
this.sendMessage(id, { audio: { url: vn }, contextInfo:{ mentionedJid:[user], "externalAdReply": { "thumbnail": apii.data, "title": `乂 ＷＥＬＣＯＭＥ 乂`, "body": wm, "previewType": "PHOTO", "thumbnailUrl": null, "showAdAttribution": true,  sourceUrl: yt,  ptt: true, mimetype: 'audio/mpeg', fileName: `error.mp3` }, { quoted: fkontak2 })
          }
        }
      }
      break;
