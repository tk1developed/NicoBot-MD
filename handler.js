...
if (!isNumber(user.inycoins)) user.exoticocoins = 5       
if (!isNumber(user.infinityserver)) user.exoticoserver = 0
if (!isNumber(user.infinitypaquete)) user.exoticopaquete = 0
...
this.sendMessage(m.chat, {text: `❮💰❯ 𝙉𝙤 𝙩𝙞𝙚𝙣𝙚𝙨 𝙨𝙪𝙛𝙞𝙘𝙞𝙚𝙣𝙩𝙚𝙨 𝘽𝙤𝙩𝘾𝙤𝙞𝙣𝙨 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤.`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: packname, previewType: 0, thumbnail: img, sourceUrl: redesYoshi }}}, { quoted: m })         
continue     
}

m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `❮💎❯ 𝙉𝙤 𝙩𝙞𝙚𝙣𝙚𝙨 𝙨𝙪𝙛𝙞𝙘𝙞𝙚𝙣𝙩𝙚𝙨 𝘿𝙞𝙖𝙢𝙖𝙣𝙩𝙚𝙨 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤. 𝙋𝙖𝙧𝙖 𝙘𝙤𝙢𝙥𝙧𝙖𝙧 𝙢𝙖𝙨 𝙙𝙞𝙖𝙢𝙖𝙣𝙩𝙚𝙨, 𝙪𝙨𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤.\n\n• 𝙋𝙤𝙧 𝙚𝙟𝙚𝙢𝙥𝙡𝙤:\n\n*${usedPrefix}buyall*\n*${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: packname, previewType: 0, thumbnail: img, sourceUrl: redesYoshi }}}, { quoted: m })         
continue
}

if (!isPrems && plugin.inycoins && global.db.data.users[m.sender].inycoins < plugin.inycoins * 1) {
this.sendMessage(m.chat, {text: `❮☁️❯ 𝙉𝙤 𝙩𝙞𝙚𝙣𝙚𝙨 𝙨𝙪𝙛𝙞𝙘𝙞𝙚𝙣𝙩𝙚𝙨 𝙄𝙣𝙮𝘾𝙤𝙞𝙣𝙨 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤. 𝙋𝙖𝙧𝙖 𝙘𝙤𝙢𝙥𝙧𝙖𝙧 𝙢𝙖𝙨 𝙨𝙚𝙧𝙫𝙚𝙧𝙘𝙤𝙞𝙣𝙨, 𝙪𝙨𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤.\n\n• 𝙋𝙤𝙧 𝙚𝙟𝙚𝙢𝙥𝙡𝙤:\n\n*${usedPrefix}buyallcoins*\n*${usedPrefix}buycoins*\n\n• 𝙑𝙞𝙨𝙞𝙩𝙖 𝙡𝙖 𝙩𝙞𝙚𝙣𝙙𝙖 𝙚𝙣: #tiendainfinity`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: packname, previewType: 0, thumbnail: img, sourceUrl: redesYoshi }}}, { quoted: m })         
continue
}
...
this.sendMessage(m.chat, {text: `❮📣❯ 𝙍𝙚𝙦𝙪𝙞𝙚𝙧𝙚𝙨 𝙚𝙡 𝙣𝙞𝙫𝙚𝙡: *${plugin.level}*\n\n• 𝙏𝙪 𝙣𝙞𝙫𝙚𝙡 𝙖𝙘𝙩𝙪𝙖𝙡 𝙚𝙨: *${_user.level}*\n\n• 𝙐𝙨𝙖 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙥𝙖𝙧𝙖 𝙨𝙪𝙗𝙞𝙧 𝙙𝙚 𝙣𝙞𝙫𝙚𝙡:\n*${usedPrefix}levelup*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: packname, previewType: 0, thumbnail: img, sourceUrl: redesYoshi }}}, { quoted: m })         
continue
}
let extra = {
match,
...
if (db.data.chats[m.chat].reaction && m.text.match(/(ción|dad|aje|oso|izar|yoshii|yoshi|yoshiko|na|ho|qu|a|ja|js|mente|pero|tion|age|ous|ate|and|but|ify)/gi)) {
...
"thumbnail": apii.data, 
"title": [wm, packname, '𝗬𝗼𝘀𝗵𝗶𝗸𝗼𝗕𝗼𝘁-𝗠𝗗 💫👑'].getRandom(),
