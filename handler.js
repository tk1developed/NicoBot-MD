...
text = (action === 'add' ? (chat.sBye || this.bye || conn.bye || 'Bye, @user!')).replace('@bio', about).replace('@user', '@' + user.split('@')[0]);
...
this.sendMessage(id, byegc, 'sticker.webp', '', null, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '乂 ＡＤＩＯ́Ｓ 乂', body: `${wm}`, mediaType: 2, sourceUrl: `${pickRandom([md, yt])}`, thumbnail: apii.data}}})
          }
        }
      }
      break;
