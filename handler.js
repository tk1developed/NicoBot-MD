...
this.sendMessage(id, text, text, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: true, title: wm, body: `h`, mediaType: 2, sourceUrl: md, thumbnail: apii.data}, mentionedJid: [user]}}, { quoted: m })
