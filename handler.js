...
this.sendMessage(id, { text: text, contextInfo:{ mentionedJid:[user], "externalAdReply": {"showAdAttribution": true, "containsAutoReply": true, "title": `${action === 'add' ? '🍬 W E L C O M E 🍓' : '🍫 A D I O S 🍬'}`, "body": packname, "previewType": "PHOTO", "thumbnailUrl": ``, "thumbnail": apii.data, "sourceUrl": channel}}})
}}}
      break;
    case 'promote':
    case 'daradmin':
