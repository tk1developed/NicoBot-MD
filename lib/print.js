...
export default async function (m, conn = { user: {} }) {
    ...
    console.log(`
${chalk.black(chalk.cyan('╭───────────────────╼'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.bgBlue('Bot ⪼'))} ${chalk.black(chalk.bgGreen('%s'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.bgBlue('Versión ⪼'))} ${chalk.black(chalk.bgGreen('${global.vs}'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.bgBlue('Hora ⪼'))} ${chalk.black(chalk.bgGreen('${oraItaliana}'))}
${chalk.black(chalk.cyan('│'))} 
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.bgGreen('%s'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.bgGreen('%s [%s %sB]'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.bgGreen('%s'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.bgGreen('%s%s'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.bgGreen('${chatName}'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.bgGreen('%s'))}
${chalk.black(chalk.cyan('╰───────────────────╼'))}
`.trim(),
