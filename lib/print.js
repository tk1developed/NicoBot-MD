...
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.blue('Bot ⪼'))} ${chalk.black(chalk.green('%s'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.blue('Versión ⪼'))} ${chalk.black(chalk.green('${global.vs}'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.blue('Hora ⪼'))} ${chalk.black(chalk.green('${oraItaliana}'))}
${chalk.black(chalk.cyan('│'))} 
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.green('%s'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.green('%s [%s %sB]'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.green('%s'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.green('%s%s'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.green('${chatName}'))}
${chalk.black(chalk.cyan('│✰'))} ${chalk.black(chalk.green('%s'))}
${chalk.black(chalk.cyan('╰───────────────────╼'))}
`.trim(),
