...
${chalk.bold.magenta(`\n│────────────\n│')} ${chalk.redBright('%s')}\n${chalk.bold.white(`┃➺')}ㅤ${chalk.black(chalk.bgYellow('%s'))}\n┃➺ㅤ${chalk.black(chalk.bgGreen('%s'))}\n${chalk.bold.white(`┃➺')}ㅤ${chalk.magenta('%s [%s %sB]')}
┃➺ ${chalk.green('%s')}\n${chalk.bold.white(`┃➺')}ㅤ${chalk.yellow('%s%s')}\n${chalk.bold.white(`┃➺')}ㅤ${chalk.green('%s')}\n${chalk.bold.white(`┃➺')}ㅤ${chalk.black(chalk.bgYellow('%s'))}
${chalk.bold.red(`\n️▣────────────···')}
`.trim(),

  me + ' ~' + conn.user.name + `${conn.user.jid == global.conn.user.jid ? '' : '【𝗦𝗕 - 𝗦𝗨𝗕 𝗕𝗢𝗧】'}`,
