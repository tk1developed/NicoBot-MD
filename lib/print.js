...
${chalk.black(chalk.green('│◈'))} Bot ⪼ ${chalk.black(chalk.green('%s'))}
${chalk.black(chalk.green('│◈'))} Versión ⪼ ${global.vs}
${chalk.black(chalk.green('│◈'))} Hora ⪼ ${oraItaliana}
${chalk.black(chalk.green('│'))}
${chalk.black(chalk.green('│◈'))} ${chalk.black(chalk.cyan('%s'))}
${chalk.black(chalk.green('│◈'))} ${chalk.black(chalk.cyan('%s [%s %sB]'))}
${chalk.black(chalk.green('│◈'))} ${chalk.black(chalk.cyan('%s'))}
${chalk.black(chalk.green('│◈'))} ${chalk.black(chalk.cyan('%s%s'))}
${chalk.black(chalk.green('│◈'))} ${chatName}
${chalk.black(chalk.green('│◈'))} ${chalk.black(chalk.cyan('%s'))}
${chalk.black(chalk.cyan('╰───────────────────╼'))}
`.trim(),
