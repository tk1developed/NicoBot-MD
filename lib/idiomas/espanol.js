...
const smsJoin1 = () => { return `*INGRESE EL ENLACE DE UN GRUPO*\n*EJEMPLO:*\n*${usedPrefix + command}* ${gp2}`}

const smsJoin2 = () => { return `${packname}\n*SE HA UNIDO AL GRUPO ✅*`}

const smsJoin = (user) => { return `${packname}\n_😻 SE HA UNIDO AL GRUPO_\n\n🫶 *FUE AGREGADA POR: @${user}*`}

export default { lenguaje, smsIniJadi, smsIniJadi2, smsWelcome, smsBye, smsPromote, smsDemote, smsDesc, smsSubject, smsIcon, smsRevoke, smsJoin1, smsJoin2, smsJoin}