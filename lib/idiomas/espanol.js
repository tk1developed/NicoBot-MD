...
const smsSoloOwnerJB = () => { return `👑 𝙼𝚒 𝚙𝚛𝚘𝚙𝚒𝚎𝚝𝚊𝚛𝚒𝚘 𝚍𝚎𝚜𝚊𝚌𝚝𝚒𝚟𝚘 𝚎𝚜𝚝𝚊 𝚏𝚞𝚗𝚌𝚒𝚘𝚗`}

const smsJBConexion = () => { return `'🎌 *𝙻𝚊 𝚌𝚘𝚗𝚎𝚡𝚒𝚘𝚗 𝚜𝚎 𝚌𝚎𝚛𝚛𝚘 𝚜𝚎 𝚒𝚗𝚝𝚎𝚗𝚝𝚊𝚛𝚊 𝚛𝚎𝚌𝚘𝚗𝚎𝚌𝚝𝚊𝚛 :𝙳*`}


const smsJBConexionClose = () => { return `🍂 *La conexión se ha cerrado, tendras que volver a conectarse usando:*\n!deletesesion (Para borrar los datos y poder volver a solitar el QR o el código de emparejamiento`}

const smsJBConexionClose2 = () => { return `🍂 *La conexión se ha cerrado, tendras que volver a conectarse usando:*\n!deletesesion (Para borrar los datos y poder volver a solitar el QR o el código de emparejamiento`}

const smsJBConexionTrue = () => { return `🌺 𝚅𝚊𝚕𝚎 𝚏𝚞𝚎 𝚝𝚘𝚍𝚘 𝚞𝚗 𝚎𝚡𝚒𝚝𝚘 𝚊𝚑𝚘𝚛𝚊 𝚎𝚛𝚎𝚜 𝚞𝚗𝚊 𝚂𝚞𝚋-𝙱𝚘𝚝 :𝟹`}

const smsJBConexionTrue2 = () => { return `🌻 𝙴𝚡𝚒𝚝𝚘 𝚕𝚊 𝚋𝚘𝚝 𝚎𝚜𝚝𝚊 𝚌𝚘𝚗𝚎𝚌𝚝𝚊𝚍𝚊, 𝚙𝚊𝚛𝚊 𝚟𝚘𝚕𝚟𝚎𝚛 𝚊 𝚌𝚘𝚗𝚎𝚌𝚝𝚊𝚛 𝚕𝚊 𝚋𝚘𝚝 𝚞𝚜𝚎 𝚜𝚞 (𝙸𝙳) 𝚘 𝚞𝚜𝚎:`}

const smsJBCargando = () => { return `😊 𝙼𝚞𝚢 𝚋𝚒𝚎𝚗, 𝚕𝚊 𝚋𝚘𝚝 𝚎𝚜𝚝𝚊 𝚕𝚎𝚢𝚎𝚗𝚍𝚘 𝚕𝚘𝚜 𝚖𝚎𝚗𝚜𝚊𝚓𝚎𝚜 𝚎𝚗 𝚎𝚜𝚙𝚎𝚛𝚊`}
