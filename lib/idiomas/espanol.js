...
const smsDemote = () => { return `❏ 🍃 *_@user ha dejado de ser administrador._*`}

const smsDesc = () => { return `❏ 🍃 *_Se ha modificado la descripción del grupo._*\n\n*Nueva Descripción:* @desc`}

const smsSubject = () => { return `❏ 🍃 *_Se ha modificado el nombre del grupo._*\n*Nuevo Nombre:* @subject`}

const smsIcon = () => { return `❏ 🍃 *_Se ha cambiado la foto del grupo._*`}

const smsRevoke = () => { return `❏ 🍃 *_Se ha actualizado el link del grupo._*\n*Link Nuevo:* @revoke`}
