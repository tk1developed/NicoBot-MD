...
//main.js
const smsWelcome = () => { return `╭᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─•\n│⌑┏┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄•◌ͦ\n│⌑┃ ${wm}\n│⌑┗┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄•◌ͦ\n╰────────────────────────•\n\n❮🎉❯ *Bienvenido (a)*\n@user\n*Gracias Por Unirte Aquí*\n\n⎔ Grupo: @subject\n\n❮🍁❯ *Lea la descripción del grupo:*\n${String.fromCharCode(8206).repeat(850)}\n@desc`}

const smsBye = () => { return `╭᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─᷼─•\n│⌑┏┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄•◌ͦ\n│⌑┃ ${wm}\n│⌑┗┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄•◌ͦ\n╰────────────────────────•\n\n❮👋🏻❯ *Hasta luego*\n@user\n\n• No fue digno(a) de estar aquí 🫵😆`}
