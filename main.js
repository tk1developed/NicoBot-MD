...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '╔═══❖•ೋ° °ೋ•❖═══╗*\n*╟❧ @subject*\n*╔═══❖•ೋ° °ೋ•❖═══╗*\n*╟❧ @user*\n*╟ඬ⃟ 🚀 BIENVENIDO💖* \n*║*\n*╟ඬ⃟ ✨ 𝙳𝙴𝚂𝙲𝚁𝙸𝙿𝙲𝙸𝙾𝙽 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾:*\n\n@desc\n\n*║*\n*╟ඬ⃟ 🌵 Dɪғʀᴜᴛᴀ Tᴜ Esᴛᴀᴅɪᴀ✨!!*\n*╚═══❖•ೋ° °ೋ•❖═══╝*';
  conn.bye = '╔═══❖•ೋ° °ೋ•❖═══╗*\n*╟❧ @user*\n*╟ඬ⃟ 😹 𝙰𝚂𝚃𝙰 𝙿𝚁𝙾𝙽𝚃𝙾 𝙵𝙰𝙽𝚂 𝙳𝙴 𝙱𝚃𝚂 👋🏻* \n*╚═══❖•ೋ° °ೋ•❖═══╝*';

  conn.spromote = '*@user Bienvenido Al Staff Ya Eres Admin🥳!!*';
  conn.sdemote = '*@user Joderte Ya No Tienes Poder En El Grupo!!*';
...
setInterval(async () => {
  ...
  const bio = `By:Diego✨️💖 - 𝘚𝘢𝘬𝘶𝘳𝘪𝘵𝘢𝘉𝘰𝘵-𝘔𝘋 Activo Durante: ⏳️ ${uptime}`;
