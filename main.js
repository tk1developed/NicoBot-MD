...
mobile: MethodMobile, 
browser: opcion == '1' ? ['SakuraBotLite-MD', 'Safari', '2.0.0'] : methodCodeQR ? ['SakuraBotLite-MD', 'Safari', '2.0.0'] : ['Bot', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
function clockString(ms) {
  ...
  return [d, 'd ️', h, 'h ', m, 'm ', s, 'm '].map((v) => v.toString().padStart(2, 0)).join('');
}
