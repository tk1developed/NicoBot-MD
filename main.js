...
const directories = ['./ShinoSession/', './jadibts/']
...
setInterval(async () => {
  ...
  const bio = `✨💖𝘚𝘢𝘬𝘶𝘳𝘢𝘉𝘰𝘵-𝘔𝘋 ⏳️ ${uptime}`;
...
function clockString(ms) {
  ...
  return [d, '  ️', h, '  ', m, '  ', s, ' Segundo(s) '].map((v) => v.toString().padStart(2, 0)).join('');
}
