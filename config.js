...
//• ↳ ◜𝑭𝑨𝑲𝑬◞ • 🍁
global.fake = { contextInfo: { mentionedJid: conn.parseMention(wm), forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '0029VaHdt8oJENxtNExL8z2n/208@newsletter', serverMessageId: '', newsletterName: 'SB - UPDATE 🌸' }, externalAdReply: { title: wm, body: vs, mediaType: 1, renderLargerThumbnail: false, previewType: `PHOTO`, thumbnailUrl: imagen4, thumbnail: imagen6, sourceUrl: yt }}}, { quoted: m } //fake con reenviado de canal
