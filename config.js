...
//• ↳ ◜𝑭𝑨𝑲𝑬!◞ • 🈸
//global.fake = { contextInfo: { mentionedJid: conn.parseMention(wm), forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363192715606792@newsletter', serverMessageId: '', newsletterName: 'SB - UPDATE 🌸' }, externalAdReply: { title: wm, body: vs, mediaType: 1, renderLargerThumbnail: false, previewType: `PHOTO`, thumbnailUrl: imagen4, thumbnail: imagen6, sourceUrl: global.gp1 }}}, { quoted: m }
